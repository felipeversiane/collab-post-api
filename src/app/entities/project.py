...
class Project(models.Model):
    ...
    description = models.TextField(max_lenght=200,null=False, blank=False,verbose_name=_('Description'),validators=[validate_first_letter])
    ...
    employer = models.ForeignKey(User,null=False, blank=False, on_delete=models.CASCADE, related_name='projects',verbose_name=_('Project Manager'))
